...
Matter.Common.extend(Matter.Body, MatterWrap);
//Matter.use('matter-wrap')

function runMatter(container) {
...
export function initMatter() {
  const container = document.getElementById("wrapper-canvas");
  if (!container) {
    return;
  }
